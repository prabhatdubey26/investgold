...
$.extend($.facebox,{settings:{opacity:0.2,overlay:true,loadingImage:'/re/common/images/loading.gif',closeImage:'/re/common/images/closelabel.png',imageTypes:['png','jpg','jpeg','gif'],faceboxHtml:'\
    <div id="facebox" style="display:none;"> \
      <div class="popup"> \
        <div class="content"> \
        </div> \
        <a href="#" class="close"><img src="/re/common/images/closelabel.png" title="close" class="close_image" /></a> \
      </div> \
