			...
			<section class="section2 clearfix">
				...
				<div class="col2 column2 last">
					<div class="sec2innercont">
						<div class="sec2addr">
							<p>Gold & Silver Krugerrand Dealer - South Africa</p>
							<p><span class="collig">Phone :</span> + 044 877 0339</p>
							<p><span class="collig">Email :</span> abc@gmail.com</p>
							<p><span class="collig">Fax :</span> +013 110 3180</p>
						</div>
					</div>
					<div class="sec2contactform">
						...
						<form action="">
							...
							<div class="clearfix">
								<textarea name="textarea" id="" cols="30" rows="4">Your message here...</textarea>
							</div>
