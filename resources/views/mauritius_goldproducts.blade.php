  ...
  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="card mb-4">
      ...
      <div class="card-body text-center">
        ...
        <button data-id="{{$product->id}}" data-name="{{$product->title}}" data-summary="" data-price="{{$product->price}}" data-quantity="1" data-image="{{ asset('assets/storage/img/products/Mauritius/Gold/') }}/{{$product->image}}" class="btn btn-danger btn-sm my-cart-btn">Add to cart</button>
